...
<form action="{{ route('user_store') }}" method="post">
    @csrf
    <input name="name" type="text" placeholder="имя..." value="{{ old('name') }}"> Ваше имя<br><br>
    <input name="login" type="email" placeholder="email" value="{{ old('login') }}"> Придумайте логин<br><br>
